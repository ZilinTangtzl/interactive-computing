class Inventory {
    ...
    displayMusicNotesSection() {
        ...
        console.log("Music Notes Status:", {
            sixteenth: this.musicNotes.sixteenth,
            eighth: this.musicNotes.eighth,
            quarter: this.musicNotes.quarter,
            achievement: this.musicNotes.achievement
        });
    ...
    addGhostNote(noteType) {
        console.log("Adding Ghost Note:", {
            type: noteType,
            before: {...this.musicNotes}
        });
        ...
        console.log("After Adding Note:", {
            after: {...this.musicNotes}
        });
    ...
    checkForAchievement() {
        console.log("Checking Achievement:", {
            quarterNotes: this.musicNotes.quarter,
            currentAchievement: this.musicNotes.achievement
        });
        ...
        if (this.musicNotes.quarter >= 4 && !this.musicNotes.achievement) {
            ...
            console.log("Achievement Unlocked!", {
                remainingQuarters: this.musicNotes.quarter,
                achievementStatus: this.musicNotes.achievement
            });
            ...
            if (keyboardButton) {
                ...
                keyboardButton.style.bottom = '20px';
                keyboardButton.style.right = '20px';
                keyboardButton.style.zIndex = '1000';

                let buttonLink = document.createElement('a');
                buttonLink.href = 'keyboard.html';
                buttonLink.style.padding = '10px';
                buttonLink.style.fontSize = '16px';
                buttonLink.style.backgroundColor = '#6a0dad';
                buttonLink.style.color = 'white';
                buttonLink.style.textDecoration = 'none';
                buttonLink.style.borderRadius = '5px';
                buttonLink.innerText = 'Open Keyboard';

                keyboardButton.appendChild(buttonLink);
    ...
    getItemCount(itemId) {
        ...
        console.log('Inventory: Get item count', {
            itemId: itemId,
            count: count,
            allItems: this.items
        });
