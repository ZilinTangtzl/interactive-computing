...
class GameManager {
    ...
    saveGame() {
        const saveData = {
            ...
            inventory: {
                ...
                musicNotes: playerInventory.musicNotes
            },
    ...
    loadGame() {
        ...
        if (savedData) {
            ...
            if (gameData.inventory.musicNotes) {
                playerInventory.musicNotes = gameData.inventory.musicNotes;
            }

            playerInventory.items = gameData.inventory.items;

            this.year = gameData.gameState.year || 1;
    ...
    getCurrentTimeString() {
        ...
        let minuteStr = this.minute < 10 ? '0' + this.minute : this.minute.toString();
        return hourStr + ':' + minuteStr;
    }

    getCurrentDate() {
        return `Year${this.year}-${this.season}-${this.day}`;
    }
